...
namespace AoC._2019._17
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            input[0] = 2;
            var comp = new IntCode(input, new int[] {
                'A', 44, 'A', 44, 'B', 44, 'C', 44, 'C', 44, 'A', 44, 'B', 44, 'C', 44, 'A', 44, 'B', 10,
                'L', 44, '1', '2', 44, 'L', 44, '1', '2', 44, 'R', 44, '1', '2', 10,
                'L', 44, '8', 44, 'L', 44, '8', 44, 'R', 44, '1', '2', 44, 'L', 44, '8', 44, 'L', 44, '8', 10,
                'L', 44, '1', '0', 44, 'R', 44, '8', 44, 'R', 44, '1', '2', 10,
                'n', 10
            });
            while (true)
            {
                var output = comp.RunProgram();
                if (output.HasValue)
                {
                    if (output > 255)
                    {
